function [rect button] = e_getrect(varargin)
...
if (nargin < 1)
    ...
    set(GETRECT_FIG, 'CurrentCharacter', 'z');
else
...
set(GETRECT_FIG, ...
    'Pointer', 'crosshair', ...
    'KeyPressFcn', 'e_getrect(''KeyPress'');', ...
...
elseif (~ishghandle(GETRECT_H1) || ...
    ...
    button = get(GETRECT_FIG, 'CurrentCharacter');
end
...
key = get(GETRECT_FIG, 'CurrentCharacter');
set(GETRECT_H1, 'UserData', 'Completed');
switch key
